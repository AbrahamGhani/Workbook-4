...
public class Student extends Person {
    ...
    public Student(int id, String github, String linkedin, String codingNickname, String codewarsXPoints, String imageUrl, String deviceType, int pageNumberWorkbook, String currentlyWorkingOn) {
        this.id = id;
        this.github = github;
